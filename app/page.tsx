	...
	return (
		<main className="w-screen h-screen bg-background">
			<div className="flex flex-col absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-2/3 w-full text-gray ">
				<h1 className={"text-7xl sm:text-8xl md:text-9xl text-center " + valenciaFont.className}>Bartosz Wiaderek</h1>
				<h2 className={"text-1xl sm:text-2xl md:text-3xl text-center mt-3 " + openSansFont.className}>Website available later...</h2>
			</div>
